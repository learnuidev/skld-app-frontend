            ...
            {days.map((day, i) => {
              ...
              return (
                <div key={day} className="flex flex-1 flex-col items-center gap-2">
                  <div
                    className={i === highlight ? "w-6 rounded-t-md bg-blue-500" : "w-6 rounded-t-md bg-[#dbeafe]"}
                    style={{ height: `${height}%` }}
                  />
                </div>
              );
      ...
      <main className="mx-auto max-w-6xl px-4 pb-24 pt-10 sm:px-6">
        {name ? (
          <>
            ...
            {/* Week summary */}
            <section className="mt-6 overflow-hidden rounded-3xl border border-emerald-100 bg-emerald-50 p-6 sm:p-8">
            ...
            <section className="mt-8">
              ...
              <div className="mt-4 rounded-3xl border border-border bg-white p-6 shadow-sm">
          ...
          <div className="mx-auto mt-8 max-w-md rounded-3xl border border-border bg-white p-8 text-center shadow-sm">
